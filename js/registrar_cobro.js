// Obtener el botón
const openPopupBtn = document.getElementById("Button-Registro");
...
openPopupBtn.addEventListener("click", () => {
  ...
  const popupWindow = window.open("tipo_pago.html", "PopupWindow", `width=${popupWidth},height=${popupHeight},left=${leftPosition},top=${topPosition}`);
});